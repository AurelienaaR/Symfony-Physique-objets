...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('vhTqVRUNl8', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CR3J5lNmNc', 0, 'R19uxgPTATKyBQUX2MRbOv', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bnaMA0xImv', 0, 'R19uxgPTATKyBQUX2MRbOv', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('K0Swfjg-II', 0, 'R19uxgPTATKyBQUX2MRbOv', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'physdb', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a75448c3341e08f0610cc165260ec637254cdff21a612e634d28f64e62a8446c');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j->createUser(new \Symfony\Component\Security\Core\User\User('user', '593fc8501e2938.12962686', array(0 => 'ROLE_USER')));
        $j->createUser(new \Symfony\Component\Security\Core\User\User('author', '593fc8501e2938.12962686', array(0 => 'ROLE_AUTHOR')));
        $j->createUser(new \Symfony\Component\Security\Core\User\User('admin', '593fc8501e2938.12962686', array(0 => 'ROLE_ADMIN')));
        $j->createUser(new \Symfony\Component\Security\Core\User\User('superadmin', '593fc8501e2938.12962686', array(0 => 'ROLE_SUPER_ADMIN')));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $j, 1 => $c), 'main', $a, $d, $e), 2 => $m, 3 => $q, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $l, $h, $a, $d, true, $n), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '593fc8501e35e2.56678858', $a, $h), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('debug.security.access.decision_manager'), $i, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $e, $k, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $k, 'login', false), NULL, NULL, $a, false));
    }
