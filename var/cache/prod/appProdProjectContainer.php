...
class appProdProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SitephysPhysmvcBundle', ($this->targetDirs[3].'/app/Resources/SitephysPhysmvcBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SitephysPhysmvcBundle', ($this->targetDirs[3].'/src/Sitephys/PhysmvcBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SitephysUserBundle', ($this->targetDirs[3].'/app/Resources/SitephysUserBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SitephysUserBundle', ($this->targetDirs[3].'/src/Sitephys/UserBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('YW-FxvfL3H', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KXptn7CpU-', 0, 'a6MIGq18peBC-tquw+VTId', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'physdb', 'user' => 'newuser', 'password' => 'Tf1wuWCbb6LF', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Sitephys/PhysmvcBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Sitephys/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Sitephys\\PhysmvcBundle\\Entity');
        $c->addDriver($b, 'Sitephys\\UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('SitephysPhysmvcBundle' => 'Sitephys\\PhysmvcBundle\\Entity', 'SitephysUserBundle' => 'Sitephys\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_56b0faaf9a3714a8518c3dff14dd34a39f67c9e4796b7592b7a7bcebd167e663');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Sitephys\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j->createUser(new \Symfony\Component\Security\Core\User\User('user', '5935569f13c834.48218117', array(0 => 'ROLE_USER')));
        $j->createUser(new \Symfony\Component\Security\Core\User\User('author', '5935569f13c834.48218117', array(0 => 'ROLE_AUTHOR')));
        $j->createUser(new \Symfony\Component\Security\Core\User\User('admin', '5935569f13c834.48218117', array(0 => 'ROLE_ADMIN')));
        $j->createUser(new \Symfony\Component\Security\Core\User\User('superadmin', '5935569f13c834.48218117', array(0 => 'ROLE_SUPER_ADMIN')));
        ...
        $q = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $h, $n, $k, 'main', $o, $p, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $q->setRememberMeServices($l);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $j, 1 => $c), 'main', $a, $d, $e), 2 => $m, 3 => $q, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $l, $h, $a, $d, true, $n), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5935569f13d893.80873241', $a, $h), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $i, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $e, $k, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $k, 'login', false), NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer(array(0 => new \FOS\RestBundle\Serializer\Normalizer\FormErrorNormalizer($this->get('translator')), 1 => new \FOS\RestBundle\Serializer\Normalizer\ExceptionNormalizer(new \FOS\RestBundle\Util\ExceptionValueMap(array('Symfony\\Component\\HttpKernel\\Exception\\HttpException' => true, 'Symfony\\Component\\Security\\Core\\Exception\\BadCredentialsException' => true)), false), 2 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 3 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 4 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(), 5 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 6 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(new \Symfony\Component\Serializer\Mapping\Factory\CacheClassMetadataFactory(new \Symfony\Component\Serializer\Mapping\Factory\ClassMetadataFactory(new \Symfony\Component\Serializer\Mapping\Loader\LoaderChain(array()), NULL), $this->get('cache.serializer')), NULL, $this->get('property_accessor'), NULL)), array(0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder()));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('mail.firstheberg.net');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'FOSRestBundle', 9 => 'SitephysPhysmvcBundle', 10 => 'SitephysUserBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Sitephys/PhysmvcBundle/Resources/views'), 'SitephysPhysmvc');
        $instance->addPath(($this->targetDirs[3].'/src/Sitephys/UserBundle/Resources/views'), 'SitephysUser');
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eCu3I93FVh', 0, 'a6MIGq18peBC-tquw+VTId', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iU4nxZ1-cI', 0, 'a6MIGq18peBC-tquw+VTId', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_AUTHOR', 1 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Sitephys\\UserBundle\\Entity\\User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SitephysPhysmvcBundle' => 'Sitephys\\PhysmvcBundle\\SitephysPhysmvcBundle',
                'SitephysUserBundle' => 'Sitephys\\UserBundle\\SitephysUserBundle',
            ),
            'kernel.bundles_metadata' => array(
                ...
                'SitephysPhysmvcBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Sitephys/PhysmvcBundle'),
                    'namespace' => 'Sitephys\\PhysmvcBundle',
                ),
                'SitephysUserBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Sitephys/UserBundle'),
            ...
            'database_port' => NULL,
            'database_name' => 'physdb',
            'database_user' => 'newuser',
            'database_password' => 'Tf1wuWCbb6LF',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'mail.firstheberg.net',
            'mailer_port' => 465,
            'mailer_user' => NULL,
            ...
            'validator.mapping.cache.prefix' => 'validator_46d05ae0b81aec81eb474a897f77badfe96324d3d5f17155d83bdfded3cd8ad7',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'mail.firstheberg.net',
            ...
            'assetic.bundles' => array(
                ...
                8 => 'FOSRestBundle',
                9 => 'SitephysPhysmvcBundle',
                10 => 'SitephysUserBundle',
            ),
